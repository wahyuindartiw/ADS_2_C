  ...
  <div id="topbar" class="hoc clear"> 
    <div class="fl_left">
      <ul class="nospace">
        ...
        <li><a href="http://localhost/SI/pantiAsuhan.php">PANTI ASUHAN</a></li>
        <li><a href="http://localhost/SI/pantiJompo.php" style="color: red;">PANTI JOMPO</a></li>
      </ul>
    </div>
    <div class="fl_right">
      <ul class="nospace">
...
<div class="wrapper bgded overlay" style="height: 150px;">
  ...
  <main class="hoc container clear"> 
    <!-- main body -->
      ...
      <div class="sectiontitle">
        <h6 class="heading">Panti Jompo Kota Malang</h6>
        <p>--------------------------------------------------</p>
      </div>
